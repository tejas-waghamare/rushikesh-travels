...
//             <div className="w-10 h-10 bg-gradient-to-br from-red-500 to-red-600 rounded-lg flex items-center justify-center transform group-hover:scale-105 transition-transform duration-300 shadow-lg">
//               <span className="text-white font-bold text-lg">RT</span>
//             </div>
//           </div>
//           <div className="flex flex-col">
//             <h1 className="text-2xl font-bold bg-gradient-to-r from-red-600 to-red-700 bg-clip-text text-transparent">
//               Rushikesh Tours & Transport Pune
//             </h1>
...
//       {/* Mobile Menu */}
//       <div
//         className={`md:hidden transition-all duration-500 ease-in-out overflow-auto ${
//           isOpen
//             ? "max-h-96 opacity-100 bg-white/95 backdrop-blur-md shadow-lg"
//             : "max-h-0 opacity-0"
//         }`}
//       >
...
//             <Link
//               to="/booking"
//               className="block w-full bg-gradient-to-r from-red-500 to-red-600 text-white text-center py-3 rounded-lg font-semibold shadow-lg mb-4"
//               onClick={closeMenu}
//             >
//               Book Your Trip
//             </Link>
...
export default function Navbar() {
  ...
  return (
    ...
    >
      ...
      <div
        className={`fixed inset-0 top-[73px] md:hidden transition-all duration-500 ease-in-out ${
          isOpen
            ? "opacity-100 visible"
